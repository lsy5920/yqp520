...
export const rosterIdentityOptions: RosterIdentityOption[] = [
  ...
  { key: 'healer', label: '青囊医者', description: '适合温和、善听、愿意照顾他人的人。', icon: '药' },
  { key: 'strategist', label: '云台谋士', description: '适合思路清晰、擅长策划和分析的人。', icon: '策' },
  { key: 'artisan', label: '百工匠师', description: '适合会写、会画、会剪辑或爱做作品的人。', icon: '工' },
  { key: 'wanderer', label: '烟雨行客', description: '适合爱观察、爱记录、喜欢分享见闻的人。', icon: '游' },
  { key: 'guardian', label: '护山执事', description: '适合稳重、可靠、愿意维护秩序的人。', icon: '守' },
]
...
export const rosterBondOptions: RosterBondOption[] = [
  ...
  { key: 'companion', label: '已有同行', description: '已经有熟人一起入门，想继续同行。' },
  { key: 'mentor', label: '愿做引路', description: '愿意给新同门一点帮助和经验。' },
  { key: 'quiet', label: '静修旁观', description: '喜欢安静潜水，但也愿意守在云栖。' },
]
